...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/profile/request-two-factor-credentials', [ProfileController::class, 'getTwoFactorNewCredentials']);
    Route::post('/profile/enable-two-factor', [ProfileController::class, 'enableTwoFactor']);
    Route::post('/profile/disable-two-factor', [ProfileController::class, 'disableTwoFactor']);
